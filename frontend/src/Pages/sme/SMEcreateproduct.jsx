...
const SMECreateProduct = () => {
  ...
  const loadCategoryAttributes = async (categoryId) => {
    try {
      ...
      let attrs = [];
      try { attrs = await smeService.getCategoryAttributes(categoryId); } catch { /**/ }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await smeService.createProduct(submitData);
      ...
      setTimeout(() => navigate('/sme/products'), 3500);
    } catch (err) {
    ...
    <div className={styles.page}>
      ...
      <header className={styles.topBar}>
        <div className={styles.brand}>
          <div className={styles.brandDot}>S</div>
          <span className={styles.brandText}>Seller Hub</span>
        </div>
        ...
        <button onClick={() => navigate('/sme-dashboard')} className={styles.btnSecondary} style={{ fontSize: 13 }}>
          ✕ Cancel
        </button>
      </header>
      ...
      <div className={styles.layout}>
        ...
        <main className={styles.main}>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.formGroup}>
                ...
                {featuredImagePreview ? (
                  ...
                  <label htmlFor="sme_featured_image" className={styles.imgUpload}>
                    ...
                    <input type="file" id="sme_featured_image" accept="image/*" onChange={handleFeaturedImageChange} style={{ display: 'none' }} />
                  </label>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.imgGrid}>
                  ...
                  {imagePreviews.length < 10 && (
                    <label htmlFor="sme_additional_images" className={styles.imgAddSlot}>
                      <span>Add image</span>
                      <input type="file" id="sme_additional_images" accept="image/*" multiple onChange={handleImagesChange} style={{ display: 'none' }} />
                    </label>
                  )}
                </div>
          ...
          <div className={styles.navButtons}>
            <button type="button" className={styles.btnSecondary} onClick={currentStep === 0 ? () => navigate('/sme-dashboard') : handleBack}>
...
export default SMECreateProduct;